...
#define STRING_CONFIG_H_AUTHOR "(BDScripting, E5 Plus SKR-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E5 Plus SKR-3"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "10c3e29b-d1be-4aae-942f-9167c8196680"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, -15.5 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 45, 30 } // (mm) Left, Front, Right, Back insets
